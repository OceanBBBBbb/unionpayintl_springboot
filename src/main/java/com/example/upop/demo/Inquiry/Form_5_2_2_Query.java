package com.example.upop.demo.Inquiry;
 ...
 *
 */
public class Form_5_2_2_Query extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		resp.getWriter().write("Transaction state query Request message: <br/>"+reqMessage+"<br/>" + "Response message:</br>"+rspMessage+"");
	}
